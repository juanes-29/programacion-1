...
public class Libro {
    ...
    public LinkedList<DetallePrestamo> getListaDetallePrestamo() {
        return listaDetallePrestamos;
    }

    public void setListaDetallePrestamo(LinkedList<DetallePrestamo> listaDetallePrestamo) {
        this.listaDetallePrestamos = listaDetallePrestamo;
    }
